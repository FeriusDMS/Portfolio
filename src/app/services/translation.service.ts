...
export class TranslationService {
  ...
  private translations: Translations = {
    ...
    'about.journey.part2': { fr: ", j'ai eu la chance de partir 1 an à l'étranger aux Pays-Bas (", en: ", I had the chance to spend 1 year abroad in the Netherlands (" },
    'about.journey.part3': { fr: ") pour explorer le monde de l'Intelligence Artificielle et du Deep Learning. J'ai aussi eu l'opportunité de travailler sur des projets professionnels lors de stages chez ", en: ") to explore the world of Artificial Intelligence and Deep Learning. I also had the opportunity to work on professional projects during internships at " },
    'about.journey.part4': { fr: " et ", en: " and " },
    'about.journey.part5': { fr: ", où j'ai pu mettre en pratique mes compétences en développement.", en: ", where I was able to put my development skills into practice." },
    'about.journey.epitech': { fr: 'EPITECH', en: 'EPITECH' },
    'about.journey.hz': { fr: 'HZ University Of Applied Sciences', en: 'HZ University Of Applied Sciences' },
    ...
    'aboutDetail.personalInfo': { fr: 'J\'ai 23 ans, né le 19 janvier 2002 à Brest, en Bretagne. Passionné par l\'intelligence artificielle depuis mon adolescence, j\'ai transformé cette passion en parcours académique et professionnel.', en: 'I am 23 years old, born on January 19, 2002 in Brest, Brittany. Passionate about artificial intelligence since my adolescence, I have transformed this passion into an academic and professional path.' },
    ...
    'aboutDetail.passionDetail': { fr: 'Ce qui me fascine le plus dans l\'intelligence artificielle, c\'est la possibilité de créer des solutions innovantes qui ont un impact réel sur la vie des utilisateurs. Chaque projet est une opportunité d\'apprendre et de repousser les limites de ce qui est possible avec les technologies d\'IA.', en: 'What fascinates me most about artificial intelligence is the ability to create innovative solutions that have a real impact on users\' lives. Each project is an opportunity to learn and push the boundaries of what is possible with AI technologies.' },
    ...
    'aboutDetail.experienceDetail': { fr: 'Au fil de mes expériences, j\'ai développé une expertise particulière dans la création d\'applications modernes, performantes et scalables, avec un focus sur l\'intégration de solutions d\'IA. J\'apprécie particulièrement le travail en équipe et les méthodologies agiles qui favorisent la collaboration et l\'innovation continue.', en: 'Through my experiences, I have developed particular expertise in creating modern, performant and scalable applications, with a focus on integrating AI solutions. I particularly appreciate teamwork and agile methodologies that promote collaboration and continuous innovation.' },
    ...
    'aboutDetail.educationDetail': { fr: 'Mon parcours académique m\'a permis d\'acquérir les meilleurs bases en ce qui concerne le développement et l\'informatique, mais c\'est surtout ma curiosité et ma soif d\'apprendre qui m\'ont poussé à me former continuellement aux dernières technologies d\'IA et aux best practices du domaine. Avec bien sur l\'aide d\'EPITECH.', en: 'My academic background has allowed me to acquire the best foundations in computer science and coding, but above all it is my curiosity and thirst for learning that have pushed me to continuously train in the latest AI technologies and best practices in the field. With of course the help from EPITECH.' },
    ...
    'aboutDetail.goalsDetail': { fr: 'Je cherche constamment à améliorer mes compétences, à découvrir de nouvelles technologies d\'IA et à contribuer à des projets qui ont du sens. Mon objectif est de devenir un expert en Data Science et IA, capable de concevoir et déployer des solutions d\'intelligence artificielle de bout en bout.', en: 'I constantly seek to improve my skills, discover new AI technologies and contribute to meaningful projects. My goal is to become an expert in Data Science and AI, capable of designing and deploying end-to-end artificial intelligence solutions.' },
    ...
    'aboutDetail.hobbiesDetail': { fr: 'En dehors du code, j\'aime la musique, les jeux vidéo et les nouvelles technologies. J\'apprécie également les moments passés entre amis et en famille, ainsi que les balades en bord de mer qui me permettent de me ressourcer et de revenir avec de nouvelles idées.', en: 'Outside of coding, I enjoy music, video games and new technologies. I also appreciate time spent with friends and family, as well as walks by the sea that allow me to recharge and come back with new ideas.' },
    ...
    'schools.epitech.description': { fr: 'École d\'informatique reconnue pour son approche pédagogique innovante basée sur l\'apprentissage par projet. Formation d\'experts en technologies de l\'information avec une forte culture de l\'innovation et de l\'entrepreneuriat.', en: 'Computer science school recognized for its innovative pedagogical approach based on project-based learning. Training experts in information technologies with a strong culture of innovation and entrepreneurship.' },
    'schools.epitech.program': { fr: 'Formation complète en développement logiciel, architecture système, intelligence artificielle et gestion de projets. L\'approche pédagogique unique d\'EPITECH repose sur l\'apprentissage actif à travers des projets concrets, favorisant l\'autonomie, la créativité et le travail en équipe.', en: 'Comprehensive training in software development, system architecture, artificial intelligence and project management. EPITECH\'s unique pedagogical approach is based on active learning through concrete projects, promoting autonomy, creativity and teamwork.' },
    'schools.epitech.highlights': { fr: 'Projets techniques ambitieux incluant la création de jeux vidéo (RPG, R-Type), développement d\'applications web et mobile (Area), intelligence artificielle (Gomoku, Zappy), et restauration de logiciels legacy. Participation à des hackathons et événements tech. Développement de compétences en C/C++, Python, JavaScript, et architectures avancées.', en: 'Ambitious technical projects including video game creation (RPG, R-Type), web and mobile application development (Area), artificial intelligence (Gomoku, Zappy), and legacy software restoration. Participation in hackathons and tech events. Development of skills in C/C++, Python, JavaScript, and advanced architectures.' },
    'schools.epitech.achievements': { fr: 'Réalisation de 15+ projets techniques majeurs, maîtrise de multiples langages et frameworks, développement d\'une expertise en IA et Machine Learning, participation à des projets collaboratifs internationaux.', en: 'Completion of 15+ major technical projects, mastery of multiple languages and frameworks, development of expertise in AI and Machine Learning, participation in international collaborative projects.' },
    
    'schools.hz.name': { fr: 'HZ University of Applied Sciences', en: 'HZ University of Applied Sciences' },
    'schools.hz.degree': { fr: 'Échange International - Intelligence Artificielle', en: 'International Exchange - Artificial Intelligence' },
    'schools.hz.period': { fr: '2024 - 2025', en: '2024 - 2025' },
    'schools.hz.location': { fr: 'Middelburg, Pays-Bas', en: 'Middelburg, Netherlands' },
    'schools.hz.description': { fr: 'Université néerlandaise d\'excellence spécialisée dans les sciences appliquées. Programme d\'échange international axé sur l\'Intelligence Artificielle, le Deep Learning et les technologies émergentes.', en: 'Dutch university of excellence specializing in applied sciences. International exchange program focused on Artificial Intelligence, Deep Learning and emerging technologies.' },
    'schools.hz.program': { fr: 'Programme intensif en Intelligence Artificielle couvrant le Machine Learning, Deep Learning, Computer Vision, Natural Language Processing et Data Science. Accent sur les applications pratiques et les projets de recherche avec des cas d\'usage réels.', en: 'Intensive Artificial Intelligence program covering Machine Learning, Deep Learning, Computer Vision, Natural Language Processing and Data Science. Focus on practical applications and research projects with real use cases.' },
    'schools.hz.highlights': { fr: 'Développement d\'un projet de Computer Vision avec détection d\'objets en temps réel, étude approfondie des réseaux de neurones convolutifs (CNN), travail sur des datasets volumineux, implémentation d\'algorithmes de Deep Learning avec PyTorch et TensorFlow. Collaboration internationale avec des étudiants de 15+ nationalités.', en: 'Development of a Computer Vision project with real-time object detection, in-depth study of convolutional neural networks (CNN), work on large datasets, implementation of Deep Learning algorithms with PyTorch and TensorFlow. International collaboration with students from 15+ nationalities.' },
    'schools.hz.achievements': { fr: 'Expertise en Computer Vision et Deep Learning, maîtrise de PyTorch et TensorFlow, développement de modèles d\'IA performants, expérience internationale enrichissante avec immersion culturelle aux Pays-Bas.', en: 'Expertise in Computer Vision and Deep Learning, mastery of PyTorch and TensorFlow, development of high-performance AI models, enriching international experience with cultural immersion in the Netherlands.' },
    ...
    'companies.adesio.role': { fr: 'Développeur Full-Stack - Stage', en: 'Full-Stack Developer - Internship' },
    'companies.adesio.period': { fr: 'Février 2023 - Juin 2023, Septembre 2025 - Février 2026', en: 'February 2023 - June 2023, September 2025 - February 2026' },
    'companies.adesio.location': { fr: 'Saint-Malo, France', en: 'Saint-Malo, France' },
    'companies.adesio.description': { fr: 'Adesio est une scale-up innovante spécialisée dans les solutions de procurement intelligent pour l\'industrie électronique. Leur plateforme Smart Supply Manager® révolutionne l\'approvisionnement en composants électroniques grâce à l\'IA et l\'automatisation.', en: 'Adesio is an innovative scale-up specialized in intelligent procurement solutions for the electronics industry. Their Smart Supply Manager® platform revolutionizes electronic component sourcing through AI and automation.' },
    'companies.adesio.mission': { fr: 'Développement et amélioration de la plateforme Smart Supply Manager®, une solution de procurement multi-fournisseurs qui centralise les données en temps réel de stock, prix et délais de livraison. Travail sur l\'intégration d\'APIs de distributeurs majeurs (Arrow, Avnet, Mouser, DigiKey) et développement de fonctionnalités d\'automatisation des commandes et devis.', en: 'Development and improvement of the Smart Supply Manager® platform, a multi-supplier procurement solution that centralizes real-time stock, pricing, and delivery data. Work on integrating major distributor APIs (Arrow, Avnet, Mouser, DigiKey) and developing order and quote automation features.' },
    'companies.adesio.achievements': { fr: 'Développement de nouvelles fonctionnalités pour l\'interface web (Angular/TypeScript), intégration de multiples APIs REST de fournisseurs, optimisation des performances de l\'application, participation à l\'amélioration de l\'UX/UI, mise en place de tests automatisés, collaboration avec une équipe agile sur des sprints de 2 semaines.', en: 'Development of new features for the web interface (Angular/TypeScript), integration of multiple supplier REST APIs, application performance optimization, participation in UX/UI improvements, implementation of automated tests, collaboration with an agile team on 2-week sprints.' },
    'companies.adesio.technologies': { fr: 'Angular, TypeScript, Node.js, API REST, Git, Agile/Scrum, MongoDB, Docker', en: 'Angular, TypeScript, Node.js, REST API, Git, Agile/Scrum, MongoDB, Docker' },
    'companies.adesio.impact': { fr: 'Contribution à une plateforme utilisée par des équipes d\'achat pour optimiser leurs processus de sourcing avec des économies pouvant atteindre 70%. Amélioration de l\'expérience utilisateur et réduction du temps de traitement des commandes grâce aux fonctionnalités développées.', en: 'Contribution to a platform used by purchasing teams to optimize their sourcing processes with savings of up to 70%. Improved user experience and reduced order processing time through developed features.' },
    
    'companies.arche.name': { fr: 'ARCHE MC2', en: 'ARCHE MC2' },
    'companies.arche.role': { fr: 'Développeur Logiciel - Stage', en: 'Software Developer - Internship' },
    'companies.arche.period': { fr: 'Juillet 2022 - Décembre 2022', en: 'July 2022 - December 2022' },
    'companies.arche.location': { fr: 'Plérin, France', en: 'Plérin, France' },
    'companies.arche.description': { fr: 'ARCHE MC2 est une entreprise spécialisée dans le développement de solutions logicielles sur mesure et le conseil en technologies de l\'information. L\'entreprise accompagne ses clients dans leur transformation digitale avec une expertise forte en développement d\'applications métier.', en: 'ARCHE MC2 is a company specialized in custom software solution development and IT consulting. The company supports its clients in their digital transformation with strong expertise in business application development.' },
    'companies.arche.mission': { fr: 'Participation au développement d\'applications métier pour des clients du secteur public et privé. Travail sur des projets de digitalisation de processus métier, développement de fonctionnalités frontend et backend, maintenance corrective et évolutive d\'applications existantes.', en: 'Participation in business application development for public and private sector clients. Work on business process digitalization projects, frontend and backend feature development, corrective and evolutionary maintenance of existing applications.' },
    'companies.arche.achievements': { fr: 'Développement de nouvelles fonctionnalités pour des applications web en production, correction de bugs et amélioration de la stabilité des applications, rédaction de documentation technique, participation aux revues de code, apprentissage des méthodologies de développement professionnel et des bonnes pratiques de l\'industrie.', en: 'Development of new features for production web applications, bug fixes and application stability improvements, technical documentation writing, code review participation, learning professional development methodologies and industry best practices.' },
    'companies.arche.technologies': { fr: 'Java, Spring Boot, JavaScript, Angular, SQL, Git, Maven, Jenkins', en: 'Java, Spring Boot, JavaScript, Angular, SQL, Git, Maven, Jenkins' },
    'companies.arche.impact': { fr: 'Acquisition de solides compétences en développement professionnel, compréhension des enjeux du développement en entreprise, apprentissage des pratiques de qualité logicielle et travail en équipe sur des projets réels avec impact client.', en: 'Acquisition of solid professional development skills, understanding of enterprise development challenges, learning software quality practices and teamwork on real projects with client impact.' },
    ...
    'companyDetail.achievements': { fr: 'Réalisations & Contributions', en: 'Achievements & Contributions' },
